...
class YMXStep1(Ys):
    ...
    def get_url(self, page_num, search_keyword):
        url = "https://www.amazon.com/s?k=Scott+ComfortPlus&i=hpc&page=2&xpid=ZBJV6jPsj_XwR&crid=26PXKY0729NA1&qid=1789724888&sprefix=scott+comfortplus%2Chpc%2C491&ref=sr_pg_2"
        parsed = urlparse(url)
