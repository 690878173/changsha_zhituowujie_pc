...
class YMXStep1(Ys):
    ...
    def get_url(self, page_num, search_keyword):
        url = "https://www.amazon.com/s?k=pampers&rh=p_123%3A200890&dc&page=3&xpid=_bhlO_AyuuThh&crid=1NIIUR73547IR&qid=1789545010&rnid=85457740011&sprefix=pampers%2Caps%2C419&ref=sr_pg_3"
        parsed = urlparse(url)
