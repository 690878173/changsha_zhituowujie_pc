...
class YMXStep1(Ys):
    ...
    def get_url(self, page_num, search_keyword):
        url = "https://www.amazon.com/s?k=dymatize&page=2&xpid=sowTU_ZbxwRna&crid=17NPU982R57CT&qid=1790128901&sprefix=dymatize%2Caps%2C343&ref=sr_pg_2"
        url = 'https://www.amazon.com/s?k=dymatize&rh=p_123%3A232766&dc&crid=17NPU982R57CT&qid=1790128901&rnid=85457740011&sprefix=dymatize%2Caps%2C343&ref=sr_nr_p_123_1&ds=v1%3Avt%2FH6K0vqq8jxxC6WgUF6V1RBmPWahpXtbMKtdrgKj0&page=2'
        parsed = urlparse(url)
