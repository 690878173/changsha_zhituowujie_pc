...
class Pc(Get_Product):
    ...
    def mg_create_variation_products(self,shopify_product, woo_product):
        return super().mg_create_variation_products(shopify_product, woo_product)

    def mg_shopify_to_woocommerce(self,shopify_product,brand, custom_categories=None):
        return super().mg_shopify_to_woocommerce(shopify_product, brand, custom_categories)
