...
from _ljp.mb.base import Step6Variable
...
if __name__ == "__main__":
    Step6Variable(Tool, merge_fields=merge_fields, description_fields=description_fields,output_file=output_file,input_file=input_file).run()
