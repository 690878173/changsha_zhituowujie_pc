...
input_file = Tool.File.path_add_site('data/quchong.csv')
output_file = Tool.File.path_add_site('data/variable.csv')
...
desc_like_fields = [
    "zdy-description (product.metafields.c_f.zdy_description)",
    "zdy-detail (product.metafields.c_f.zdy_detail)",
    "zdy-how_to_use (product.metafields.c_f.zdy_how_to_use)",
    "zdy-ingredients (product.metafields.c_f.zdy_ingredients)"
]
