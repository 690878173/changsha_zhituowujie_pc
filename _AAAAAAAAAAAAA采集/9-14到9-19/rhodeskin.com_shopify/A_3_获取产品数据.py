...
class Pc(Get_Product):
    ...
    def zdy_zd(self, url):
        ...
        dic = {}
        for node in html.xpath('//div[@class="Product-tabs"]/div[@class="Product-tab"]'):
            name = node.xpath('./h3/button/span/text()')[0]

            for i in ['Benefits', 'Application','Ingredients','HOW TO USE','DETAILS']:
