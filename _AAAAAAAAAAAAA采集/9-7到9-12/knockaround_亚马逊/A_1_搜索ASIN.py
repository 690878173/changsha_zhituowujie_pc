...
class YMXStep1(Ys):
    ...
    def get_url(self, page_num, search_keyword):
        url = "https://www.amazon.com/s?k=knockaround&rh=p_123%3A80027&dc&page=2&xpid=NzFV10bf3z_WI&crid=2EV95LA3OJFXV&qid=1789048173&rnid=85457740011&sprefix=knockaround%2Caps%2C582&ref=sr_pg_2"
        parsed = urlparse(url)
