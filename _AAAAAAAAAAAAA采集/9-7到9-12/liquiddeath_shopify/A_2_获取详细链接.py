...
class Pc(GetDetail):
    ...
    def fetch_page(self, p:PageModel, params):
        ...
        if url == 'https://liquiddeath.com/en-cn/collections/beverages-eu':
            return [
        "https://liquiddeath.com/products/scary-strawberry",
        "https://liquiddeath.com/products/flavored-sparkling-variety-pack",
        "https://liquiddeath.com/products/variety-tea",
        "https://liquiddeath.com/products/mountain-water-still"
