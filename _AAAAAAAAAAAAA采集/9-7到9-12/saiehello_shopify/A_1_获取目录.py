...
def f1(dic):
    ...
    ml1 = html.xpath('//li[@class="header--link-wrapper nested"]')
    for node in ml1:
        ...
        if isinstance(child_dic, dict):
            child = node.xpath('./div[@class="header--submenu nested"]//div[@class="header--submenu-links-col"]/ul[@class="header--submenu-links-list"]/li')
            print(child)
            f2(child_dic, child)
    dic['Merch'] = {'url': 'https://saiehello.com/collections/merch', 'child': {}}
    dic['Set'] = {'url': 'https://saiehello.com/collections/sets', 'child': {}}
    print(dic)
    return dic
