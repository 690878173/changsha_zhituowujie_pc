...
class Pc(GetDetail):
    ...
    def before_request(self, p: PageModel):
        ...
        if api_url == 'https://pyrexhome.com/collections/pyrex-round-lids/Round-Lids/products.json':
            api_url = 'https://pyrexhome.com/collections/pyrex-round-lids/products.json'
