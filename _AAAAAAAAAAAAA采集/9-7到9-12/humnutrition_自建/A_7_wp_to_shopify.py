...
# ================= 维护区：自定义字段写在这里 =================
EXTRA_META_COLUMNS = [
    'Key Ingredients(product.metafields.c_f.key_ingredients)',
    'The Ick List(product.metafields.c_f.the_ick_list)',
    'Clinically Tested(product.metafields.c_f.clinically_tested)',
