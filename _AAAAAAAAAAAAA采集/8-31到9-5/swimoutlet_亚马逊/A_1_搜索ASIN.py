...
class YMXStep1(Ys):
    def get_url(self,page_num,search_keyword):
        ...
        url = "https://www.amazon.com/s?k=swimoutlet&page=7&crid=VDKZZ76Z19ST&qid=1788571626&sprefix=swimoutlet%2Caps%2C391&xpid=buFaVieBcnCiZ&ref=sr_pg_7"
        parsed = urlparse(url)
        ...
        return f'https://www.amazon.com/s?k=swimoutlet&page={page_num}&crid=VDKZZ76Z19ST&qid=1788571626&sprefix=swimoutlet%2Caps%2C391&xpid=buFaVieBcnCiZ&ref=sr_pg_{page_num}'
