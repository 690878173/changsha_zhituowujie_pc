...
class Pc(Get_Product):
    ...
    def zdy_zd(self, url):
        ...
        div_ls = html.xpath('//div[@class="product-layout__block"]/div/expandable-block')
        dic = {}

        for div_l in div_ls:
            name = div_l.xpath('./button/span/text()')
            if name:
                for i in ['Highlights','Specs','Compare Speakers']:
                    if i in name:
                        value = div_l.xpath('./div')[0]
    ...
    def fetch_product(self, url, category) -> list:
        ...
        if url in [
                "https://corporate.turtleboxaudio.com/products/conservation-grande",
                "https://corporate.turtleboxaudio.com/products/turtlebox-speaker-original",
                "https://corporate.turtleboxaudio.com/products/turtlebox-speaker-cub",
                "https://corporate.turtleboxaudio.com/products/carabiner",
                "https://corporate.turtleboxaudio.com/products/turtlebox-speaker-grande",
                "https://corporate.turtleboxaudio.com/products/conservation-ranger",
                "https://corporate.turtleboxaudio.com/products/custom-logo",
                "https://corporate.turtleboxaudio.com/products/turtlebox-tie-down-kit",
                "https://corporate.turtleboxaudio.com/products/turtlebox-speaker-ranger",
                "https://corporate.turtleboxaudio.com/products/ranger-bumpers"
            ]:
