...
class YMXStep1(Ys):
    ...
    def get_url(self, page_num, search_keyword):
        url = "https://www.amazon.com/s?k=grove&rh=p_123%3A1135385&dc&page=2&xpid=mWvHOpr8siku8&crid=KOFAMTE8YC7D&qid=1788572257&refresh=2&rnid=85457740011&sprefix=grove%2Caps%2C433&ref=sr_pg_2"
        parsed = urlparse(url)
