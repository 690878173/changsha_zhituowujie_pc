...
no_url_ls = [
        ...
        "https://www.maono.com/products/maono-arena-software",
        "https://www.maono.com/products/dgm20-noise-reduction-software",
        "https://www.maono.com/products/prostudio",
        "https://www.maono.com/products/prostudio2",
        "https://www.maono.com/products/maono-pd500w-hybrid-microphone-for-podcast",
        'https://www.maono.com/products/maonocare'
    ]
...
def shopify_get_detail_url(collection_url):
    ...
    while True:
        ...
        try:
            ...
            response = Tool.get(api_url, params=params, headers=headers, timeout=15, verify=False)
            ...
            if len(products) < 250:
                return [i for i in all_product_urls if i not in no_url_ls]
