...
def transform_images_by_rule(csv_path: str,
                             ...
                             target_prefix: str = "https://cdn.zhimatrix.com/hatch_ljp/images/"):
    """
...
if __name__ == "__main__":
    transform_images_by_rule(
        csv_path=r"J:\changsha\hatch\data\hatch_variable.csv",  # 改为你的文件路径
        output_path=r"J:\changsha\hatch\data\hatch_picture.csv",  # 可选：不填则覆盖输入
        target_prefix="https://cdn.zhimatrix.com/hatch_ljp/images/"  # 可改为你想要的前缀
    )