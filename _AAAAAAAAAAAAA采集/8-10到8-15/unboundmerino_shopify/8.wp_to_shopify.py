...
"Fabric and Details(product.metafields.c_f.fabric_and_details)",
"The Fit(product.metafields.c_f.the_fit)"
]
# =============================================================
...
COLUMN_RENAME_MAP = {
    ...
    # 新增三个自定义字段映射
    'Specifications(product.metafields.c_f.specifications)': 'specifications',
    'Fabric and Details(product.metafields.c_f.fabric_and_details)': 'fabric_details',
    'The Fit(product.metafields.c_f.the_fit)': 'fit',
}
        ...
        for idx, var in enumerate(child_df.itertuples(index=False, name='VarRow')):
            ...
            if idx == 0:
                ...
                for col in EXTRA_META_COLUMNS:
                    new_col = COLUMN_RENAME_MAP[col]  # 因为有映射，直接取
